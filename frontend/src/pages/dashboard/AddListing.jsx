...
const AddListing = () => {
  ...
  const performPincodeLookup = async (pincode) => {
    ...
    try {
      ...
      const response = await fetch(`${API}/api/utilities/pincode/${pincode}`);
    ...
    switch (currentStep) {
        ...
        return (
          ...
          >
            <div className="border-b pb-4 mb-4 border-emerald-100">
              <h2 className="text-xl font-bold text-emerald-800">Property Details</h2>
              <p className="text-sm text-emerald-500">All fields marked with <span className="text-emerald-500">*</span> are mandatory.</p>
            </div>

            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <label className="block mb-2 text-sm font-semibold text-emerald-700">
                  Listing Title <span className="text-emerald-500">*</span>
                </label>
                <input
                  type="text"
                  name="title"
                  ...
                  className="w-full border border-emerald-300 rounded-lg p-3 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all outline-none bg-white/95 backdrop-blur-sm shadow-sm hover:shadow-md"
                  required
                />
              </div>
              <div>
                <label className="block mb-2 text-sm font-semibold text-emerald-700">
                  Property Type <span className="text-emerald-500">*</span>
                </label>
                <select
                  name="propertyType"
                  value={formData.propertyType}
                  onChange={handleInputChange}
                  className="w-full border border-emerald-300 rounded-lg p-3 focus:ring-2 focus:ring-emerald-500 outline-none bg-white/95 backdrop-blur-sm shadow-sm hover:shadow-md"
                  required
                >
            ...
            <h3 className="text-lg font-bold text-emerald-800 pt-4 border-t mt-4 border-emerald-100">Property Location</h3>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="md:col-span-1">
                ...
                {pincodeError && (
                  <p className="text-emerald-500 text-xs mt-1 bg-emerald-50/50 p-2 rounded-lg">{pincodeError}</p>
                )}
              </div>

              <div className="md:col-span-1">
                <label className="block mb-2 text-sm font-semibold text-emerald-700">
                  District (City/Area) <span className="text-emerald-500">*</span>
                </label>
                <input
                  type="text"
                  name="district"
                  ...
                  className="w-full border border-emerald-300 rounded-lg p-3 focus:ring-2 focus:ring-emerald-500 outline-none bg-emerald-50/80 disabled:bg-emerald-50 shadow-sm"
                  required
            ...
            <div>
              <label className="block mb-2 text-sm font-semibold text-emerald-700">
                Full Street Address (Building, Street, Landmark) <span className="text-emerald-500">*</span>
              </label>
              {/* <input
                type="text"
                name="streetAddress" 
              ...
              />
              <p className="text-xs text-emerald-500 mt-1 bg-emerald-50/50 p-2 rounded-lg">
      ...
      case 2:
        return (
          ...
          >
            <div className="border-b pb-4 mb-4 border-emerald-100">
              <h2 className="text-xl font-bold text-emerald-800">Pricing & Amenities</h2>
              <p className="text-sm text-emerald-500">Define your rates and facilities.</p>
            </div>

            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <label className="block mb-2 text-sm font-semibold text-emerald-700">
                  Monthly Rent (₹) <span className="text-emerald-500">*</span>
                </label>
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    placeholder="5500"
                    className="w-full pl-10 border border-emerald-300 rounded-lg p-3 focus:ring-2 focus:ring-emerald-500 outline-none bg-white/95 backdrop-blur-sm shadow-sm hover:shadow-md"
                    required
                  />
                </div>
              </div>
              ...
              <div>
                <label className="block mb-2 text-sm font-semibold text-emerald-700">
                  Security Deposit (₹) <span className="text-emerald-500">*</span>
                </label>
                <div className="relative">
                  <FaRupeeSign className="absolute left-3 top-3 text-emerald-500 w-4 h-4" />
                  <input
            ...
            <div>
              <label className="block mb-2 text-sm font-semibold text-emerald-700">
                Occupancy Type <span className="text-emerald-500">*</span>
              </label>
            ...
            <div>
              <label className="block mb-3 text-sm font-semibold text-emerald-700">
                Amenities <span className="text-emerald-500">*</span>
              </label>
                ...
                {amenityOptions.map((amenity) => (
                  ...
                  >
                    <input
                      ...
                      className="hidden"
                    />
                    <div className={`w-4 h-4 mr-2 rounded border flex items-center justify-center ${formData.amenities.includes(amenity) ? "bg-emerald-500 border-emerald-500" : "border-emerald-300"
                      }`}>
              ...
              <div className="mt-3">
                <label className="block mb-1 text-xs font-semibold text-emerald-500 uppercase tracking-wide">
                  Other Amenities
                </label>
                <input
                  type="text"
                  ...
                  className="w-full border border-emerald-300 rounded-lg p-3 text-sm focus:ring-2 focus:ring-emerald-500 outline-none bg-white/95 backdrop-blur-sm shadow-sm hover:shadow-md"
                />
                <p className="text-xs text-emerald-500 mt-1 bg-emerald-50/50 p-2 rounded-lg">
        ...
        return (
          ...
          >
            <div className="border-b pb-4 mb-4 border-emerald-100">
              ...
              <p className="text-sm text-emerald-500">Make your listing stand out visually.</p>
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full border border-emerald-300 rounded-lg p-3 focus:ring-2 focus:ring-emerald-500 outline-none resize-none bg-white/95 backdrop-blur-sm shadow-sm hover:shadow-md"
                required
              ></textarea>
            </div>
            ...
            <div>
              ...
              <div className="border-2 border-dashed border-emerald-300 rounded-xl p-8 text-center hover:bg-emerald-50/50 transition-colors relative group bg-emerald-50/30">
                <input
                  type="file"
                  id="images"
                  accept="image/*"
                ...
                <div className="flex flex-col items-center justify-center text-emerald-500">
                  ...
                  <p className="text-xs text-emerald-400 mt-1">SVG, PNG, JPG or GIF (max 5MB)</p>
                </div>
              </div>
            </div>
            {formData.images.length > 0 && (
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 mt-4">
                {formData.images.map((file, index) => (
                  <div key={index} className="relative group rounded-lg overflow-hidden shadow-sm border border-emerald-200 bg-white">
                    <img
                    ...
                    <button
                      ...
                      className="absolute top-1 right-1 bg-white/90 backdrop-blur-sm rounded-full p-1 text-emerald-500 opacity-80 hover:opacity-100 shadow-sm transition-opacity hover:bg-emerald-50"
                    >
                      <XCircleIcon />
                    </button>
                  </div>
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-emerald-50/90 via-emerald-50 to-mint-50 font-sans">
      ...
      <div className="flex flex-1">
        ...
        <main className="flex-1 p-6 md:p-10 max-w-5xl mx-auto w-full">
          <motion.div
            ...
            className="mb-8"
          >
            <h1 className="text-3xl font-bold text-emerald-800">Add New Listing</h1>
            <p className="text-emerald-500 mt-1">Connect with students and migrants by listing your property on Zip Nivasa.</p>
          </motion.div>

          <div className="bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-emerald-100 overflow-hidden">

            <div className="bg-emerald-50/90 px-8 py-6 border-b border-emerald-100 backdrop-blur-sm">
              <div className="flex items-center justify-between relative">
                <div className="absolute left-0 top-1/2 transform -translate-y-1/2 w-full h-1 bg-emerald-200 -z-0 rounded-full mx-4"></div>
                <div
                  className="absolute left-0 top-1/2 transform -translate-y-1/2 h-1 bg-emerald-500 -z-0 rounded-full mx-4 transition-all duration-500 ease-out"
                ...
                {steps.map((step) => (
                  <div key={step.id} className="relative z-10 flex flex-col items-center">
                    ...
                    <span className={`mt-2 text-xs font-bold uppercase tracking-wider ${currentStep >= step.id ? "text-emerald-600" : "text-emerald-400"
                      }`}>
                      {step.name}
                    </span>
                  </div>
              ...
              <div className="flex justify-between items-center mt-10 pt-6 border-t border-emerald-100">
                {currentStep > 1 ? (
                  <button
                    type="button"
                    onClick={handleBack}
                    className="px-6 py-2.5 text-emerald-600 font-semibold rounded-lg hover:bg-emerald-50/80 transition-colors flex items-center gap-2 border border-emerald-200 hover:border-emerald-300 shadow-sm"
                  >
